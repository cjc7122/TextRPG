...
import json, keyboard, time, Buddy1
...
def BuddySystem(BuddyNumber, Task):
    ...
    if BuddyNumber == "3":
        ...
        if Buddy3['Task'] == "Mining":
            if Buddy3['Object'] == "Stone" or Buddy3['Object'] == "stone":
                Buddy3['ObjectValue'] = 0
                Buddy3['exp'] = 1
            elif Buddy3['Object'] == "Coal" or Buddy3['Object'] == "coal":
                if UserData['Mining'][0] >= 5:
                    Buddy3['ObjectValue'] = 1
                    Buddy3['exp'] = 5
            elif Buddy3['Object'] == "Tin" or Buddy3['Object'] == "tin":
                if UserData['Mining'][0] >= 10:
                    Buddy3['ObjectValue'] = 2
                    Buddy3['exp'] = 10
            elif Buddy3['Object'] == "Copper" or Buddy3['Object'] == "copper":
                if UserData['Mining'][0] >= 15:
                    Buddy3['ObjectValue'] = 3
                    Buddy3['exp'] = 25
        elif Buddy3['Task'] == "Chopping":
            if Buddy3['Object'] == "Oak" or Buddy3['Object'] == "oak":
                Buddy3['ObjectValue'] = 0
                Buddy3['exp'] = 1
            elif Buddy3['Object'] == "Birch" or Buddy3['Object'] == "Birch":
                if UserData['Chopping'][0] >= 5:
                    Buddy3['ObjectValue'] = 1
                    Buddy3['exp'] = 5
    elif BuddyNumber == 0:
...
while(Game == 1):
    ...
    #opens task list
    if Task == "List" or Task == "list":
        print("Levels\nInv\nSave\nMine\nChop")
    #opens mine list
    elif Task == "Mine" or Task == "mine":
        print("You can mine the following:\nStone(Level 1)\nCoal(Level 5)\nTin Ore (Level 10)\nCopper Ore (Level 15)\nIron Ore (Level 25)\nGold Ore(Level 35)\nTitanium Ore (Level 45)\nDiamond (Level 55)\nTungsten (Level 75)\nMeteorite (Level 85)")
    #opens chop list
    elif Task == "Chop" or Task == "chop":
        print("Choppity chop chop")
    #shows user stats
    elif Task == "Levels" or Task == "levels":
        print("Username:", UserData['Username'])
        print("Stat Points:", UserData['StatPoints'][0])
        print("Level: ", UserData['Main'][0], "(", UserData['Main'][1], "/", UserData['Main'][2], ")\n")
    ...
    #shows inventory
    elif Task == "Inv" or Task == "inv" or Task == "Inventory" or Task == "inventory":
        print("Stone: ", Inv['Mining'][0], "\nCoal: ", Inv['Mining'][1], "\nTin: ", Inv['Mining'][2], "\nCopper: ", Inv['Mining'][3], "\nOak: ", Inv['Chopping'][0], "\nBirch: ", Inv['Chopping'][1])
    #turns on afk mode
    elif Task == "afk":
        Task = input("What task would you like to afk: ")
        afk = "on"
    #sets buddy task
    elif Task == "SetBuddy" or Task == "Setbuddy" or Task == "setBuddy" or Task == "setbuddy":
        with open('Buddy1Data.json', 'r') as f:
            Buddy1 = json.load(f)
        with open('Buddy2Data.json', 'r') as f:
            Buddy2 = json.load(f)
    ...
    if Task == "Mine Stone" or Task == "Mine stone" or Task == "mine Stone" or Task == "mine stone":
        wait = range(5)
        for n in wait:
            print("...")
    ...
    elif Task == "Mine Coal" or Task == "Mine coal" or Task == "mine Coal" or Task == "mine coal":
        if UserData['Mining'][0] >= 5:
            wait = range(5)
            for n in wait:
                print("...")
            ...
            afk = "off"
    elif Task == "Mine Tin" or Task == "Mine tin" or Task == "mine Tin" or Task == "mine tin":
        if UserData['Mining'][0] >= 10:
            wait = range(5)
            for n in wait:
                print("...")
            ...
            afk = "off"
    elif Task == "Mine Copper" or Task == "Mine copper" or Task == "mine Copper" or Task == "mine copper":
        if UserData['Mining'][0] >= 15:
            wait = range(5)
            for n in wait:
                print("...")
    ...
    if Task == "Chop Oak" or Task == "chop Oak" or Task == "Chop oak" or Task == "chop oak":
        wait = range(5)
        for n in wait:
            print("...")
    ...
    elif Task == "Chop Birch" or Task == "chop Birch" or Task == "Chop birch" or Task == "chop birch":
        if UserData['Chopping'][0] >= 5:
            wait = range(5)
            for n in wait:
                print("...")
